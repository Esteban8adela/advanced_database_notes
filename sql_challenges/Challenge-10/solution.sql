...
-- 1. Create tables (no constraints yet)
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."ACCOUNTS" 
   (	"ACCOUNT_ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."BRICKS" 
   (	"BRICK_ID" NUMBER(*,0), 
	"COLOUR" VARCHAR2(10), 
	"SHAPE" VARCHAR2(10), 
	"WEIGHT" NUMBER(*,0)
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."CUSTOMER" 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."CUSTOMER_SALE" 
  ...
  TABLESPACE "USERS"  ENABLE, 
	 CONSTRAINT "FK_CUSTOMER_SALE_CUST" FOREIGN KEY ("CUST_ID")
	  REFERENCES "A01645033_SCHEMA_MXVOZ"."CUSTOMER" ("CUST_ID") ENABLE
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" 
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."DOC_CHUNKS" 
 ...
 VECTOR ("CHUNK_VECTOR") STORE AS (
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."MY_BRICK_COLLECTION" 
   (	"COLOUR" VARCHAR2(10), 
	"SHAPE" VARCHAR2(10), 
	"WEIGHT" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "A01645033_SCHEMA_MXVOZ"."PET_CARE_LOG" 
...
-- 3. Create indexes
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."PK_CUSTOMER" ON "A01645033_SCHEMA_MXVOZ"."CUSTOMER" ("CUST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 

  
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."PK_CUSTOMER_SALE" ON "A01645033_SCHEMA_MXVOZ"."CUSTOMER_SALE" ("SALES_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 

  
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."PK_PET_CARE_LOG" ON "A01645033_SCHEMA_MXVOZ"."PET_CARE_LOG" ("PRODUCT_ID", "LOG_DATETIME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 

  
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."PK_PRODUCT" ON "A01645033_SCHEMA_MXVOZ"."PRODUCT" ("PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 

  
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."PK_SALES_ITEM" ON "A01645033_SCHEMA_MXVOZ"."SALES_ITEM" ("SALES_ID", "PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  TABLESPACE "USERS" 

  
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."SYS_C002905925" ON "A01645033_SCHEMA_MXVOZ"."TASKS" ("ID") 
  ...
  CREATE UNIQUE INDEX "A01645033_SCHEMA_MXVOZ"."SYS_C002905948" ON "A01645033_SCHEMA_MXVOZ"."TASK_LOGS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "A01645033_SCHEMA_MXVOZ"."DEPOSIT_FUNDS" (
...
ALTER TABLE "A01645033_SCHEMA_636DB"."DOC_CHUNKS" MODIFY ("CHUNK_ID" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."DOC_CHUNKS" ADD PRIMARY KEY ("CHUNK_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" MODIFY ("VISIT_ID" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" MODIFY ("PATIENT_ID" NOT NULL ENABLE)

  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" MODIFY ("SITE_ID" NOT NULL ENABLE)

  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" MODIFY ("VISIT_DATE" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" MODIFY ("STATUS" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."PATIENT_VISITS" ADD PRIMARY KEY ("VISIT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  ALTER TABLE "A01645033_SCHEMA_636DB"."ACCOUNTS" MODIFY ("OWNER_NAME" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."ACCOUNTS" MODIFY ("BALANCE" NOT NULL ENABLE)
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."ACCOUNTS" ADD CHECK (balance >= 0) ENABLE
  
  ALTER TABLE "A01645033_SCHEMA_636DB"."ACCOUNTS" ADD PRIMARY KEY ("ACCOUNT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
